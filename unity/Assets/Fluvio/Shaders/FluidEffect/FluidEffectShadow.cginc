...
#if defined(UNITY_STANDARD_USE_SHADOW_UVS)
half alpha = tex2D(_MainTex, i.tex).a;half alphaTest = _Cutoff2;
#if defined(_ALPHATEST_ON)
clip (alpha - alphaTest);
#endif
#if defined(_ALPHABLEND_ON)
#ifdef UNITY_STANDARD_USE_DITHER_MASK
half alphaRef = tex3D(_DitherMaskLOD, float3(vpos.xy*0.25,alpha*0.9375)).a;clip (alphaRef - alphaTest);
#else 
clip (alpha - alphaTest);
#endif
#endif
