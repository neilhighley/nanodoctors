...
public class OVRPlayerController : MonoBehaviour
{
	...
	public virtual void UpdateMovement()
	{
		...
		bool moveForward = Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.UpArrow) || Input.GetAxis("Vertical")>0f;
		bool moveLeft = Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.LeftArrow) || Input.GetAxis("Horizontal") < 0f;
		bool moveRight = Input.GetKey(KeyCode.D) || Input.GetKey(KeyCode.RightArrow) || Input.GetAxis("Horizontal") > 0f;
		bool moveBack = Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow) || Input.GetAxis("Vertical") < 0f;
        ...
        if (Input.GetButtonDown("Fire1")) Fire1Action();
        if (Input.GetButtonDown("Fire2")) Fire2Action();
        if (Input.GetButtonDown("Fire3")) Fire3Action();
        

    }

    private void Fire3Action()
    {
       // Debug.Log("Fire3");
    }

    private void Fire2Action()
    {
        //Debug.Log("Fire2");
    }

    private void Fire1Action()
    {
       // Debug.Log("Fire1");
    }
